...
with_node \
  ...
  --target "/Users/phucmai/Documents/Personal Projects/TravelLog/ios/Pods/Target Support Files/Pods-traveltailor/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-random" "expo-router" "expo-system-ui" "expo-web-browser"
